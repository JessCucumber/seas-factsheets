...
var showGroupTooltip = function (event, d, color, data) {
    ...
    if (d.category.startsWith('Total')) {
        ...
        `;
        // Add additional note for the "Other" category
        if (d.category === "Other") {
            htmlContent += `
            <tr><td>Consisting of:</td><td></td></tr>
            <tr><td>Deep well injection</td><td></td></tr>
            <tr><td>Long term storage</td><td></td></tr>
            <tr><td>Surface disposal</td><td></td></tr>
            <tr><td>Unknown disposition</td><td></td></tr>
            `;
        }
    }
